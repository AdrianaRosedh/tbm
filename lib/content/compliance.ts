/**
 * C-TPAT / OEA security program copy, shared by the compliance page and the
 * homepage compliance band (single source — wording mirrors tbmcarriers.com).
 */

export const COMPLIANCE_LEAD =
  "Implementing, following, and maintaining procedures and best practices consistent with C-TPAT/OEA security criteria:";

export const COMPLIANCE_PRACTICES = [
